        ...
        subServices: [
          {
            id: 'blog-posts',
            title: 'Blog Posts',
            description: 'Create high-quality blog content that drives traffic and engagement.',
            subDescription: 'Generate engaging and informative blog posts that capture your audience’s attention and drive traffic to your website.',
            image: 'https://images.unsplash.com/photo-1501504905224-a97b24679b78?auto=format&fit=crop&q=80&w=2000&h=1000',
            features: [
              {
          ...
          },
          {
            ...
            subDescription: 'Create compelling social media content that captures attention, drives engagement, and enhances your brand’s online presence.',
            image: 'https://images.unsplash.com/photo-1516321318423-f06f8586179c?auto=format&fit=crop&q=80&w=2000&h=1000',
            features: [
              {
                title: 'Smart Content Generation',
                description:
        ...
        subServices: [
          {
            ...
            subDescription: 'Enhance your customer service with AI-powered chatbots that provide instant support, answer queries, and improve customer satisfaction.',
            image: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&q=80&w=2000&h=1000',
            features: [
              {
            ...
            process: [
              ...
              },
              {
                title: 'Design',
                description:
                  'Design the chatbot flow and conversation logic.',
              },
              {
                title: 'Implementation',
                description:
                  'Deploy and integrate the chatbot into your systems.',
              },
              {
                title: 'Optimization',
                description:
          ...
          },
          {
            ...
            description:
              'Automate repetitive tasks with AI-powered bots.',
            subDescription: 'Automate repetitive tasks with AI-powered bots, freeing up your team to focus on more strategic initiatives and complex problem-solving.',
            image: 'https://images.unsplash.com/photo-1588196749488-91f229821610?auto=format&fit=crop&q=80&w=2000&h=1000',
            features: [
              {
        ...
        subServices: [
          {
            ...
            subDescription: 'Develop custom AI models tailored to your specific requirements, leveraging the latest machine learning techniques and algorithms.',
            image: 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&q=80&w=2000&h=1000',
            features: [
              {
            ...
            benefits: [
              ...
              },
              {
                ...
                description:
                  'Gain a competitive edge with custom AI solutions.',
              },
            ],
            process: [
              {
          ...
          },
          {
            ...
            subDescription: 'Develop custom AI APIs for seamless integration with your systems, enabling you to leverage AI capabilities across your applications.',
            image: 'https://images.unsplash.com/photo-1555066931-4365465db35e?auto=format&fit=crop&q=80&w=2000&h=1000',
            features: [
              {
            ...
            benefits: [
              ...
              },
              {
                ...
                description:
                  'Build APIs that can scale with your business needs.',
              },
            ],
            process: [
              {
              ...
              },
              {
                title: 'Development',
                description:
                  'Develop the API using the latest technologies.',
              },
              {
                title: 'Testing',
                description:
                  'Test the API to ensure it meets your requirements.',
              },
              {
                title: 'Deployment',
        ...
        subServices: [
          {
            ...
            subDescription: 'Anticipate future trends and outcomes using AI-driven predictive analytics, enabling you to make informed decisions and optimize your strategies.',
            image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=2000&h=1000',
            features: [
              {
                title: 'Data Analysis',
                description:
              ...
              },
              {
                ...
                description:
                  'Generate tailored reports for your business needs.',
              },
            ],
            benefits: [
              {
              ...
              },
              {
                ...
                description:
                  'Anticipate future trends and outcomes with accuracy.',
              },
            ],
            process: [
              {
              ...
              },
              {
                ...
                description:
                  'Build predictive models based on your data.',
              },
              {
                title: 'Reporting',
                description:
          ...
          },
          {
            ...
            subDescription: 'Transform your raw data into interactive and insightful dashboards, enabling you to understand complex information at a glance.',
            image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=2000&h=1000',
            features: [
              {
              ...
              },
              {
                ...
                description:
                  'Build custom visualizations to represent your data.',
              },
              {
                title: 'Real-time Updates',
                description:
                  'Get real-time updates on your data.',
              },
            ],
            benefits: [
              {
            ...
            process: [
              ...
              },
              {
                title: 'Visualization',
                description:
                  'Create visual representations of data for clarity.',
              },
              {
